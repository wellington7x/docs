...
var valorAssinatura = payload.response_json.usuarios.valorAssinatura;
...
1. Para configurar a captura de dados através do **Enviar Webhook**, primeiramente você pode definir a URL de um sistema externo e escolher o método de solicitação (GET).
...
**Observação:** No código, acessamos especificamente a propriedade `payload.response_json.usuarios.valorAssinatura` que corresponde ao valor atual da assinatura.
